...
import (
	...
	versioned "github.com/SpeedVan/function-manager/k8s/group/client/clientset/versioned"
	internalinterfaces "github.com/SpeedVan/function-manager/k8s/group/client/informers/externalversions/internalinterfaces"
	v1 "github.com/SpeedVan/function-manager/k8s/group/client/listers/faas/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.FaasV1().Functions(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FaasV1().Functions(namespace).Watch(options)
			},
		},
		&faasv1.Function{},
		resyncPeriod,
...
func (f *functionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&faasv1.Function{}, f.defaultInformer)
}
