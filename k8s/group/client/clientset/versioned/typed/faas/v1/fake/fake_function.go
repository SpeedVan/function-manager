...
var functionsResource = schema.GroupVersionResource{Group: "faas.k8s.io", Version: "v1", Resource: "functions"}

var functionsKind = schema.GroupVersionKind{Group: "faas.k8s.io", Version: "v1", Kind: "Function"}
...
func (c *FakeFunctions) Get(name string, options v1.GetOptions) (result *faasv1.Function, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(functionsResource, c.ns, name), &faasv1.Function{})

	if obj == nil {
		return nil, err
	}
	return obj.(*faasv1.Function), err
}
...
func (c *FakeFunctions) List(opts v1.ListOptions) (result *faasv1.FunctionList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(functionsResource, functionsKind, c.ns, opts), &faasv1.FunctionList{})
	...
	list := &faasv1.FunctionList{ListMeta: obj.(*faasv1.FunctionList).ListMeta}
	for _, item := range obj.(*faasv1.FunctionList).Items {
...
func (c *FakeFunctions) Create(function *faasv1.Function) (result *faasv1.Function, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(functionsResource, c.ns, function), &faasv1.Function{})
...
func (c *FakeFunctions) Update(function *faasv1.Function) (result *faasv1.Function, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(functionsResource, c.ns, function), &faasv1.Function{})
...
func (c *FakeFunctions) UpdateStatus(function *faasv1.Function) (*faasv1.Function, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(functionsResource, "status", c.ns, function), &faasv1.Function{})
...
func (c *FakeFunctions) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(functionsResource, c.ns, name), &faasv1.Function{})
...
func (c *FakeFunctions) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &faasv1.FunctionList{})
	return err
}
...
func (c *FakeFunctions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *faasv1.Function, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(functionsResource, c.ns, name, pt, data, subresources...), &faasv1.Function{})
